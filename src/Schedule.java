...
public class Schedule extends JFrame implements TableModelListener {
	...
	public Schedule() {
		...
		/*
		 * table.setValueAt("Edit", 1, 0); table.setValueAt("free", 1, 1);
		 * table.setValueAt("7:00", 1, 2); table.setValueAt("8:30", 1, 3);
		 * 
		 * table.setValueAt("Edit", 2, 0); table.setValueAt("Ryan", 2, 1);
		 * table.setValueAt("8:30", 2, 2); table.setValueAt("9:30", 2, 3);
		 * 
		 * table.setValueAt("Edit", 3, 0); table.setValueAt("free", 3, 1);
		 * table.setValueAt("9:30", 3, 2); table.setValueAt("11:30", 3, 3);
		 * 
		 * table.setValueAt("Edit", 4, 0); table.setValueAt("lunch", 4, 1);
		 * table.setValueAt("11:30", 4, 2); table.setValueAt("12:30", 4, 3);
		 * 
		 * table.setValueAt("Edit", 5, 0); table.setValueAt("Robert", 5, 1);
		 * table.setValueAt("12:30", 5, 2); table.setValueAt("1:00", 5, 3);
		 * 
		 * table.setValueAt("Edit", 6, 0); table.setValueAt("free", 6, 1);
		 * table.setValueAt("1:00", 6, 2); table.setValueAt("4:00", 6, 3);
		 */
